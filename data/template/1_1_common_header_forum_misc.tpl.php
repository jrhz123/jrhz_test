...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1408325480, '1', './data/template/1_1_common_header_forum_misc.tpl.php', './template/default', 'common/header_forum_misc')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1408325480, '1', './data/template/1_1_common_header_forum_misc.tpl.php', './template/default', 'common/header_forum_misc')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1408325480, '1', './data/template/1_1_common_header_forum_misc.tpl.php', './template/default', 'common/header_forum_misc')
;?>
