...
class model_forum_thread extends discuz_model
{
	...
	public function newthread($parameters) {
		...
		if (empty($this->member['uid'])) {  //Enicn_d modified 2017-04-11 彻底禁止匿名帖子的发布
			return 'postperm_login_nopermission_mobile';
		}
		...
		if($this->param['modnewthreads']) {
			...
			//Enicn_d modified 2015-04-03 11:31 todayposts times 1
