...
function cardInit() {
	var cardShow = function (obj) {
		...
		//Enicn_d modified 2015-04-10 cancel usercard.
...
//Enicn_d modified 2015-04-01 16:18
//Enicn_d modified 2015-04-23 17:11 changed the calculate way of subject length
var objBorderColor = null;
function strLenCalc(obj, checklen, maxlen) {
	var v = obj.value, charlen = 0, maxlen = !maxlen ? 200 : maxlen, curlen = maxlen, len = strlen(v);
	if (objBorderColor===null) {
		objBorderColor = obj.style.borderColor;
	}
	if (maxlen == 30) {
