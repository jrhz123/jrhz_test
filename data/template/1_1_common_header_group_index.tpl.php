...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1408325870, '1', './data/template/1_1_common_header_group_index.tpl.php', './template/default', 'common/header_group_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1408325870, '1', './data/template/1_1_common_header_group_index.tpl.php', './template/default', 'common/header_group_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1408325870, '1', './data/template/1_1_common_header_group_index.tpl.php', './template/default', 'common/header_group_index')
;?>
