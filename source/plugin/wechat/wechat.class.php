...
class WeChat {
	...
	static public function register($username, $return = 0, $groupid = 0) {
		...
		//Enicn_d modified 2015-06-01 added password notification alert.
		//stellar 删除 2015-07-22 影响跳转
		/*require_once DISCUZ_ROOT . './source/class/class_core.php';
		$ntype = 'system';
		$note = '感谢您的注册以及对东江论坛的支持。当前登录账号的初始密码为【'.$password.'】，请及时修改以免遗失。';
		notification_add($uid, $ntype, $note, $notevars = array(), $system = 1, $category = 3);*/
