...
if (empty($_GET['op'])) {
	...
	<html>
		<head>
			...
			<script language="javascript" src="static/js/bbcode.js"></script>
			<style type="text/css">
				...
				*:lang(zh) .tble{top:2px}
				.tbri{width:120px;position:absolute;right:3px;top:2px;}
	...
	<?php } ?>
											...
											<div class="icons tbri">
												...
												<a href="javascript:;" style="margin-right:5px" class="icoFullTxt" onClick="fGetEv(event);pb();return false;"><?php echo lang('home/editor', 'editor_auto_format'); ?></a>
											</div>
										</div>
