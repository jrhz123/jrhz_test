...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = '4nsR_';
$_config['cookie']['cookiedomain'] = 'huizhou.cn';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '7ccffffUNlWAsRvY';
...
$_config['admincp']['founder'] = '1,210535';
