...
function getuserprofile($field) {
	...
	static $tablefields = array(
		...
		'verify'	=> array('verify1', 'verify2', 'verify3', 'verify4', 'verify5', 'verify6', 'verify7', 'verify8'), //modified by Enicn_d 2017-03-03 增加认证类型 verify8
	);
	$profiletable = '';
...
//Enicn_d 修改 2015-08-12 站点统计
require_once DISCUZ_ROOT.'/cs.php';
