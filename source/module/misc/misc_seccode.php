...
EOF;
	...
	if($_G['setting']['seccodedata']['type'] == 2 && !extension_loaded('ming') && $_POST['fromFlash'] != 1 || $_G['setting']['seccodedata']['type'] == 3 && $_GET['fromFlash'] != 1) { //Enicn_d modified 20170725 避免 bbs.huizhou.cn 登录无法查看验证码的问题
		exit('Access Denied');
	}
