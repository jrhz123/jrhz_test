...
if(!$_GET['bank_type']){
	...
	$orderid = dgmdate(TIMESTAMP, 'YmdHis').random(18);  //创建支付订单号
	DB::query("INSERT INTO ".DB::table('xj_eventpay_log')." 
	(applyid, uid, tid, orderid, paytype, subject, price, total_fee, create_time) 
	VALUES 
	('$applyid', '$uid', '$tid', '$orderid', '$paytype', '$subject', '$use_cost', '$price', '$create_time')");
}
