...
function space_domain($space) {
	...
	/**
	Enicn_d modified 2015-04-16 modified domain url
	*/
	if(!empty($_G['setting']['domain']['app']['home'])) {
		$space['domainurl'] = 'http://'.$_G['setting']['domain']['app']['home'].'/space-index-'.$space['uid'].'.html';
	} elseif(empty($space['domainurl'])) {
		$space['domainurl'] = $_G['siteurl'].'space-index-'.$space['uid'].'.html';
	}
