...
class block_blog extends discuz_block {
	...
	function fields() {
		return array(
				...
				'blog_type' => array('name' => '博客类型', 'formtype' => 'text', 'datatype' => 'string'), //Enicn_d added 2015-07-10 blog_type
				'icon_style' => array('name' => '图标类型', 'formtype' => 'text', 'datatype' => 'string'), //Enicn_d added 2015-07-10 icon_style
	...
	function getdata($style, $parameter) {
		...
		while($data = DB::fetch($query)) {
			...
			$list[] = array(
				...
				'fields' => array(
					'blog_type' => '热门', //Enicn_d added 2015-07-10 blog_type
					'icon_style' => 'incons', //Enicn_d added 2015-07-10 icon_style
					...
					'replynum'=>$data['replynum']!=0 ? $data['replynum'] : ' ',
